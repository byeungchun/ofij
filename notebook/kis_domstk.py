...
def get_news_titles(tr_cont="", entp_code="", date_1="", hour_1=""):
    url = '/uapi/domestic-stock/v1/quotations/news-title'
    tr_id = "FHKST01011800"

    params = {
        "FID_NEWS_OFER_ENTP_CODE": entp_code,
        "FID_COND_MRKT_CLS_CODE": "",
        "FID_INPUT_ISCD": "",
        "FID_TITL_CNTT": "",
        "FID_INPUT_DATE_1": date_1,  # Pass the date parameter
        "FID_INPUT_HOUR_1": hour_1,  # Pass the hour parameter
        "FID_RANK_SORT_CLS_CODE": "",
        "FID_INPUT_SRNO": ""
    }

    # Adding tr_cont to params if it's a subsequent call
    if tr_cont:
